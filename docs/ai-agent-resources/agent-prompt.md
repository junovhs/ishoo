...
You may read the task-defining docs first: this prompt, `north-star.md`, and the relevant issue file. After orientation, if you read additional files beyond the working set, justify why SEMMAP/trace was insufficient.
...
1. Run `semmap generate` and read `SEMMAP.md`, `north-star.md`, and the active issue file.
