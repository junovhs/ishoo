...
.stat-lbl{color:var(--t2)}.stat-val{font-weight:700;font-family:var(--fm);font-size:14px}
...
.feed{padding:36px}.feed-inner{max-width:840px;margin:0 auto}
...
.sec-line{flex:1;height:1px;background:var(--bd)}.sec-ct{font-family:var(--fm);font-size:11px;color:var(--t3)}
...
.card:hover{border-color:var(--bd2)}.card.active{border-color:var(--c-blue)}
